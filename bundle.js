...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayOfMonthWithSuffix = F2(
	function (pad, day) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(day),
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthName = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 'Sausio';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthShort = function (month) {
	var _p1 = month;
	switch (_p1.ctor) {
		case 'Jan':
			return 'Sau';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayName = function (day) {
	var _p2 = day;
	switch (_p2.ctor) {
		case 'Mon':
			return 'Pirmadienis';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayShort = function (day) {
	var _p3 = day;
	switch (_p3.ctor) {
		case 'Mon':
			return 'Pr';
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_lt_lt$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayOfMonthWithSuffix, twelveHourPeriod: _rluiten$elm_date_extra$Date_Extra_I18n_I_default$twelveHourPeriod},
	format: {date: '%Y-%m-%d', longDate: '%A, %Y, %B %-d', time: '%H:%M', longTime: '%H:%M:%S', dateTime: '%a, %-d. %b %Y. %-H:%M', firstDayOfWeek: _elm_lang$core$Date$Mon}
};
			...
			case 'Highlight':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedEvent: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedDay: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$isDateInEvent = F2(
	function (dateToTest, event) {
		var _p2 = event;
		switch (_p2.ctor) {
			case 'Point':
				return A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Same, dateToTest, _p2._1);
			case 'Period':
				return A4(_rluiten$elm_date_extra$Date_Extra_Compare$is3, _rluiten$elm_date_extra$Date_Extra_Compare$BetweenOpen, dateToTest, _p2._1, _p2._2);
			default:
				return A2(
					_elm_lang$core$List$any,
					_user$project$Main$isDateInEvent(dateToTest),
					_p2._1);
		}
	});
...
var _user$project$Main$getEventInfo = function (event) {
	var _p3 = event;
	switch (_p3.ctor) {
		case 'Point':
			return {
				ctor: '_Tuple2',
				_0: _p3._0,
				_1: _user$project$Main$datetoString(_p3._1)
			};
		case 'Period':
			return {
				ctor: '_Tuple2',
...
var _user$project$Main$toDate = function (str) {
	return A2(
		_rluiten$elm_date_extra$Date_Extra_TimeUnit$startOfTime,
		_rluiten$elm_date_extra$Date_Extra_TimeUnit$Day,
		A2(
...
var _user$project$Main$Period = F3(
	function (a, b, c) {
		return {ctor: 'Period', _0: a, _1: b, _2: c};
	});
var _user$project$Main$Point = F2(
	function (a, b) {
		return {ctor: 'Point', _0: a, _1: b};
	});
var _user$project$Main$EventList = F2(
	function (a, b) {
		return {ctor: 'EventList', _0: a, _1: b};
	});
var _user$project$Main$GetToday = function (a) {
...
var _user$project$Main$init = function () {
	var model = {
		...
		events: {
			ctor: '::',
			_0: A2(_user$project$Main$Point, 'born', _user$project$Main$born),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$Main$Period,
					'school',
					_user$project$Main$toDate('1991/09/01'),
					_user$project$Main$toDate('2003/06/01')),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$Main$Period,
						'university',
						_user$project$Main$toDate('2004/09/01'),
						_user$project$Main$toDate('2009/07/01')),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Main$EventList,
							'work',
							{
								ctor: '::',
								_0: A3(
									_user$project$Main$Period,
									'KM-soft',
									_user$project$Main$toDate('2008/06/02'),
									_user$project$Main$toDate('2008/12/20')),
								_1: {
									ctor: '::',
									_0: A3(
										_user$project$Main$Period,
										'Netwrix',
										_user$project$Main$toDate('2009/03/01'),
										_user$project$Main$toDate('2010/06/10')),
									_1: {
										ctor: '::',
										_0: A3(
											_user$project$Main$Period,
											'dataArt',
											_user$project$Main$toDate('2010/07/02'),
											_user$project$Main$toDate('2011/10/01')),
										_1: {
											ctor: '::',
											_0: A3(
												_user$project$Main$Period,
												'BRASCO',
												_user$project$Main$toDate('2012/03/01'),
												_user$project$Main$toDate('2017/10/01')),
											_1: {ctor: '[]'}
										}
									}
								}
							...
							_0: A2(
								...
								'travel',
								{
									...
									_0: A3(
										_user$project$Main$Period,
										'italy',
										_user$project$Main$toDate('2014/09/28'),
										_user$project$Main$toDate('2014/10/12')),
									_1: {
										ctor: '::',
										_0: A3(
											_user$project$Main$Period,
											'russia',
											_user$project$Main$toDate('2015/08/01'),
											_user$project$Main$toDate('2015/09/01')),
										_1: {
											ctor: '::',
											_0: A3(
												_user$project$Main$Period,
												'netherlands',
												_user$project$Main$toDate('2016/05/02'),
												_user$project$Main$toDate('2016/05/07')),
											_1: {
												ctor: '::',
												_0: A3(
													_user$project$Main$Period,
													'berlin',
													_user$project$Main$toDate('2017/05/01'),
													_user$project$Main$toDate('2017/05/06')),
												_1: {
													ctor: '::',
													_0: A3(
														_user$project$Main$Period,
														'madrid',
														_user$project$Main$toDate('2017/09/28'),
														_user$project$Main$toDate('2017/10/01')),
													_1: {ctor: '[]'}
												}
											}
		...
		selectedDay: _elm_lang$core$Maybe$Nothing
	};
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: A2(
			_elm_lang$core$Task$perform,
			function (_p4) {
				return _user$project$Main$GetToday(
					_elm_lang$core$Maybe$Just(_p4));
			},
			_elm_lang$core$Date$now)
	};
}();
var _user$project$Main$DayClick = function (a) {
	return {ctor: 'DayClick', _0: a};
};
var _user$project$Main$viewDay = F4(
	function (model, date, x, y) {
		var className = A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
				_elm_lang$core$Maybe$map,
				A2(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Same, date),
				model.selectedDay)) ? 'selected' : (A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
				_elm_lang$core$Maybe$map,
				_user$project$Main$isDateInEvent(date),
				model.selectedEvent)) ? 'highlight' : (A4(_rluiten$elm_date_extra$Date_Extra_Compare$is3, _rluiten$elm_date_extra$Date_Extra_Compare$BetweenOpen, date, _user$project$Main$born, model.today) ? 'wasted' : 'default'));
		return A2(
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$DayClick(date)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$viewYearRow = F3(
	function (model, y, days) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, day) {
...
var _user$project$Main$viewYear = F3(
	function (model, y, year) {
		var sndRow = A3(
		...
		var fstRow = A3(
			...
			model,
			y,
			A2(_elm_lang$core$List$take, 182, year));
		var txt = function () {
			var _p5 = _elm_lang$core$List$head(year);
			if (_p5.ctor === 'Nothing') {
				return '';
			} else {
				return _elm_lang$core$Basics$toString(
					_elm_lang$core$Date$year(_p5._0));
			}
		}();
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$text_,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y(
							_elm_lang$core$Basics$toString(y + 10)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class('year'),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg$text(txt),
					_1: {ctor: '[]'}
				}),
			_1: A2(_elm_lang$core$Basics_ops['++'], fstRow, sndRow)
		};
	});
var _user$project$Main$viewDecade = F3(
	function (model, y, decade) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$indexedMap,
				F2(
					...
					F2(
						function (x, y) {
							return _elm_lang$core$Native_Utils.eq(
								...
								_elm_lang$core$Date$year(y));
						}),
					decade)));
	});
var _user$project$Main$Highlight = function (a) {
	return {ctor: 'Highlight', _0: a};
};
var _user$project$Main$viewEvent = F2(
	function (model, event) {
		var subEvents = function () {
			var _p6 = event;
			if (_p6.ctor === 'EventList') {
				return A2(
					_elm_lang$core$List$map,
		...
		var _p7 = _user$project$Main$getEventInfo(event);
		var name = _p7._0;
		var date = _p7._1;
		var title = A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$Highlight(event)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		var active = A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (e) {
					return _elm_lang$core$Native_Utils.eq(event, e);
				},
				model.selectedEvent));
		var classList = {
			ctor: '::',
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(classList),
				_1: {ctor: '[]'}
			},
...
var _user$project$Main$view = function (model) {
	...
	var current = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_elm_lang$core$Maybe$map, _user$project$Main$datetoString, model.selectedDay));
	var eventsHtml = A2(
		_elm_lang$core$List$map,
		_user$project$Main$viewEvent(model),
		model.events);
