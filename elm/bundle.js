...
var _user$project$Main$today = A2(
	_elm_lang$core$Result$withDefault,
	_elm_lang$core$Date$fromTime(0),
	_elm_lang$core$Date$fromString('2016/12/23'));
var _user$project$Main$viewDay = F3(
	function (date, x, y) {
		var className = A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$After, date, _user$project$Main$today) ? 'act' : 'psv';
		return A2(
...
var _user$project$Main$viewYearRow = F2(
	function (y, days) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, day) {
					return A3(_user$project$Main$viewDay, day, (i * 7) + 33, y);
				}),
			days);
	});
var _user$project$Main$viewYear = F2(
	function (y, year) {
		var sndRow = A2(
			_user$project$Main$viewYearRow,
			y + 7,
			A2(_elm_lang$core$List$drop, 182, year.days));
		var fstRow = A2(
			_user$project$Main$viewYearRow,
			y,
			A2(_elm_lang$core$List$take, 182, year.days));
		var textOffset = y + 10;
		return {
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: _elm_lang$svg$Svg$text(
						_elm_lang$core$Basics$toString(year.year)),
					_1: {ctor: '[]'}
				}),
			_1: A2(_elm_lang$core$Basics_ops['++'], fstRow, sndRow)
		};
	});
var _user$project$Main$viewDecade = F2(
	function (y, decade) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$indexedMap,
				F2(
					function (i, year) {
						return A2(_user$project$Main$viewYear, y + ((i * 33) * 2), year);
					}),
				decade));
	});
var _user$project$Main$view = function (model) {
	var nodes = _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, decade) {
					return A2(_user$project$Main$viewDecade, (((i * 33) * 2) * 10) + 7, decade);
				}),
			model.decades));
	return A2(
...
var _user$project$Main$die = A2(
	_elm_lang$core$Result$withDefault,
	_elm_lang$core$Date$fromTime(0),
	_elm_lang$core$Date$fromString('2064/09/30'));
var _user$project$Main$born = A2(
	_elm_lang$core$Result$withDefault,
	_elm_lang$core$Date$fromTime(0),
	_elm_lang$core$Date$fromString('1984/09/30'));
